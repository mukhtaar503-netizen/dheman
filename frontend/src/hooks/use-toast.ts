...
function scheduleRemoval(toastId: string, dispatch: (action: Action) => void) {
...
function toast({ ...props }: Toast) {
  ...
  const update = (updateProps: ToasterToast) => dispatch({ type: 'ADD_TOAST', toast: { ...updateProps, id } });
